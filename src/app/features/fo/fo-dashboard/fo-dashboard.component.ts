                ...
                <div class="report-card">
                  ...
                  <div class="report-stats">
                    ...
                    <div class="stat-item">
                      ...
                      <div class="stat-content">
                        <div class="stat-value">{{ report.gapCount + report.gepCount + report.gspCount }}</div>
                        <div class="stat-label">Total Tasks</div>
                        <div class="stat-breakdown">GAP: {{ report.gapCount }} | GEP: {{ report.gepCount }} | GSP: {{ report.gspCount }}</div>
                      </div>
                    </div>
